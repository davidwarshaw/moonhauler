...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const shipDefinition = [
      [
        { type: null },
        { type: "command", angle: 1.5 * Math.PI, name: "1-0-command" },
        { type: null },
      ],
      [
        { type: "engine-small", angle: 0, name: "0-4-engine-small" },
        { type: "cross", angle: 0, name: "1-4-cross" },
      ...
      [
        { type: null },
        { type: "engine-large", angle: 1.5 * Math.PI, name: "1-5-engine-large" },
        { type: null },
      ],
    ];
    ...
    this.playState.destinationNode = "tycho-docks";
  ...
  fixShipDefinition() {
    ...
    const fixedShipDefinition = [...Array(properties.buildHeightTiles)].map(() =>
      Array(properties.buildWidthTiles).fill(emptyShipDefTile)
    );
