...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const shipDefinition = [
      ...
      [{ type: null}, { type: "beam", angle: 1.5 * Math.PI, name: '1-2-beam' }, { type: null}],
      [{ type: "cargo-empty", angle: Math.PI, name: '0-1-cargo-empty' }, { type: "cross", angle: 0, name: '1-3-cross' }, { type: "cargo-empty", angle: 0, name: '0-1-cargo-empty' }],
      [{ type: "fuel-tank", angle: 0, name: '0-1-fuel-tank' }, { type: "cross", angle: 0, name: '1-1-cross' }, { type: "fuel-tank", angle: Math.PI, name: '2-1-fuel-tank' }],
    ...
    this.fuel = 100;
    this.playState.funds = 500000;
    this.playState.currentNode = "malapert";
